    ...
    return (
        ...
        <div className="bg-transparent overflow-hidden relative lg:flex lg:items-center">
            ...
            <div className="flex items-center gap-8 p-8 lg:p-24">
                <Image src="https://images.unsplash.com/photo-1540350394557-8d14678e7f91?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1032&q=80" height={auto} width={auto} layout='' className="rounded-lg w-1/2" alt="Tree" />
                <div>
